 ...
 * <li>Its identification number (for referencing it in the FluentDB)
...
public class Resource {
	...
	public Resource(int resourceID, GMathForm[] gMathForms, Operator[] required, Operator[] modifies, double initialResourceLevel) {
	...
	private double[] CalculateResourceLevels(int numMath, Operator[] gActions, double initValue) {
